        ...
        "questions": [
            {
                ...
                "alternatives": [
                    {
                        "alternative": AlternativesChoices.A.value,
                        "content": "Dentes",
                        "is_correct": False,
                    },
                    {
                        "alternative": AlternativesChoices.B.value,
                        "content": "Cabelos",
                        "is_correct": False,
                    },
                    {
                        "alternative": AlternativesChoices.C.value,
                        "content": "Ouvidos",
                        "is_correct": True,
                    },
                    {
                        "alternative": AlternativesChoices.D.value,
                        "content": "Braços",
                        "is_correct": False,
                    },
                ],
...
def populate_exam_data(apps, schema_editor):
    ...
    for exam_data in exams:
        ...
        for index, question_data in enumerate(exam_data["questions"]):
            ...
            exam_question_relations.append(
                ExamQuestion(exam=exam, question=question, number=index + 1)
            )
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            populate_exam_data, reverse_code=migrations.RunPython.noop
        ),
    ]
